...
//  基本包
    ...
    public static String SOURCE_CONTROLLER;
...
//        初始化包路径
        ...
        SOURCE_CONTROLLER=PropertiesUtils.getValue("package.controller");
//        相对路径包
        ...
        CONTROLLER_PACKAGE = PACKAGE_PATH.replace("/",".")+SOURCE_CONTROLLER;
