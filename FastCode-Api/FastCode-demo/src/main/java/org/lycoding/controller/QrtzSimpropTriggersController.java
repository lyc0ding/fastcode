...
**/
@RestController
@RequestMapping(value = "/qrtzSimpropTriggers")
public class QrtzSimpropTriggersController{
	...
	**/
	...
	public Object deleteById ( @PathVariable Long id ){
		qrtzSimpropTriggersService.deleteById( id );
		return null;
	}
	...
	**/
	...
	public Object getById ( @PathVariable Long id ){
		qrtzSimpropTriggersService.getById( id );
		return null;
	}
	...
	**/
	...
	public Object getList (){
		qrtzSimpropTriggersService.getList();
		return null;
	}
	/**
	* @description 根据id修改
